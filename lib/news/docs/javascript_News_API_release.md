...
------------- | ------------- | -------------
**getCompanyNews** | **GET** /company_news | 
...
## 3.API详细信息
# **API名称：getCompanyNews**
> getCompanyNews(companyKw, opts)
> returnType: 'String' 
...
## 请求信息
调用地址：http://service-nl4at3t9-1259459016.ap-shanghai.apigateway.myqcloud.com/release/company_news
方法：GET
...
名称 | 类型 | 描述  | 必填  | 默认值
------------- | ------------- | ------------- | ------------- | -------------
 **companyKw** | **String**| 公司简称 | 是 | 腾讯
 **endDate** | **String**| 结束日期 | 否 | 2020-12-30
 **limit** | **Number**| 每页条数 | 否 | 10
 **offset** | **Number**| 第几页 | 否 | 0
 **startDate** | **String**| 开始日期 | 否 | 2019-06-01
...
var apiInstance = new News.NewsApi();
...
apiInstance.getCompanyNews(companyKw, opts, callback);
```
